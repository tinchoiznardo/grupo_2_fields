...
-- -----------------------------------------------------
-- Table `fields`.`product_size`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fields`.`product_size` (
  `size_id` INT NOT NULL,
  `stock` INT NOT NULL,
  `id` INT NOT NULL AUTO_INCREMENT,
  `product_id` INT NOT NULL,
  INDEX `fk_product_size_sizes1_idx` (`size_id` ASC) ,
  PRIMARY KEY (`id`, `size_id`, `product_id`),
  INDEX `fk_product_size_products1_idx` (`product_id` ASC) ,
